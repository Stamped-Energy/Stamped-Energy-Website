...
import { AssetHealthVisual, EnergyManagementVisual } from "@/components/motion-slots/SolutionsVisuals";
      ...
      <Container>
        ...
        <div className="mt-12 space-y-10 md:mt-16 md:space-y-14">
          {pillars.map((pillar, index) => (
            <article
              key={pillar.slug}
              className="grid items-center gap-8 border-t border-outline-variant/40 pt-10 lg:grid-cols-2 lg:gap-14"
            >
              <MotionSlot
              ...
              >
                {index === 0 ? <EnergyManagementVisual /> : <AssetHealthVisual />}
              </MotionSlot>
