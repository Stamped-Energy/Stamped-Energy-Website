  ...
  return (
    <section className="border-t border-outline-variant/30 bg-surface section-y">
      <Container>
        ...
        <div className="mx-auto mt-8 max-w-3xl space-y-3 md:mt-12 md:mx-0">
          {faq.items.map((item) => (
            <details
              key={item.id}
              className="group border border-outline-variant/50 bg-surface-lowest px-5 py-4 md:px-6 md:py-5 [&_summary::-webkit-details-marker]:hidden"
            >
