...
**Related:** [Master Document v1.5](/core-product/Stamped_Energy_Master_Document_v1.4.md) · [Two-Pillar Technical Framing](/core-product/Stamped_Two_Pillar_Technical_Framing_v1.md) · [Messaging canon](/outreach/skill/references/stamped-messaging-canon.md) · [Cold-call capability points](/marketing/content-strategy/positioning/cold-call-capability-points.md)
...
Maps to **Pillar 2 — Prescriptive Equipment Intelligence** in technical docs.
...
**Prescription card fields (client-visible):** What · Why · Who · Effort · Impact · When
...
| Date | Change |
| --- | --- |
| 2026-08-04 | v1 — canonical client narrative from ITC / Marut Shukla follow-up work; four-step story; WhatsApp templates; single agentic deck slide |
